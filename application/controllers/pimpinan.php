...
class Pimpinan extends CI_Controller {
	...
	function cetak_penyakit_view(){
		...
		$pdf->Write(0, 'SISTEM PENILAIAN PUSKESMAS', '', 0, 'C', true, 0, false, false, 0);
		$pdf->Write(0, 'DINAS KESEHATAN', '', 0, 'C', true, 0, false, false, 0);
		$pdf->Write(0, 'KABUPATEN JOMBANG', '', 0, 'C', true, 0, false, false, 0);
		$pdf->SetFont('helvetica', '', 9);
		$pdf->Write(0, 'Jalan Abcde'.' Telp. 0341-210-0232', '', 0, 'C', true, 0, false, false, 0);
		$pdf->Write(0, 'Email : admin@febritecno.co.id Kode Pos : 22321', '', 0, 'C', true, 0, false, false, 0);
		$pdf->Write(0, 'Peringkat Akreditasi : A Nomor : 213/BAP-S/M/TU/XI/2012 Tanggal 2 Desember 2010', '', 0, 'C', true, 0, false, false, 0);
		$pdf->Ln();
